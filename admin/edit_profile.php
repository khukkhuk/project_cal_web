	...
	<div class="container-fluid">
		<div class="row" style="height:55px;">
			<div class="col align-self-center">
				<div class="col-auto"><h4>แก้ไขข้อมูลส่วนตัว</h4></div>
			</div>
		</div>
		<div class="row">
			<div class="col align-self-center">
				<center>
					<form enctype="multipart/form-data" action="" method="post">
						<table style="width:550px; height:55px;">
							<tr>
				...
				<form method="POST" action="">
					<table class="table">
						<tr>
							<td><b>Username</b></td>
							<td><input type="text" class="form-control" name="firstname" value="<?php echo $row['username'] ?>"  required></td>
						</tr>
						<tr>
							<td><b>นามสกุล</b></td>
							<td><input type="text" class="form-control" name="lastname" value="<?php echo $row['firstname'] ?>"  required></td>
						</tr>
						<tr>
							<td><b>Person ID</b></td>
						...
						<tr>
							<td colspan="2">
								...
								<input type="submit" class="btn btn-primary" name="btn_sub" value="แก้ไขข้อมูลส่วนตัว">
...
<?php
	if(isset($_POST['btn_img'])){
		if($_FILES['upload']['name']!=""){
			...
			copy($_FILES['upload']['tmp_name'],"../img/".$_SESSION['username'].$ex);
			$part = "../img/".$_SESSION['username'].$ex;
	...
	if(isset($_POST['btn_sub'])){
		...
		if($passwordc==$password){
			$sql="UPDATE member SET firstname='$firstname',lastname='$lastname',person_id='$person_id',password='$password' WHERE member_id ='$id'";
			$result = $connect->query($sql);
			if($result==1){
