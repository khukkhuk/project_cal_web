			...
			<div class="col">
				<table class="table table-striped" style="text-align: center">
					...
					<?php
						...
						$sql = "SELECT * FROM orders WHERE member_id ='$id' ORDER BY orders_id DESC";

						if(isset($_GET['txt_search'])){
							$txt_search = $_GET['txt_search'];
							$sql = "SELECT * FROM orders WHERE member_id ='$id' AND (datecreate LIKE '%".$txt_search."%') ORDER BY orders_id DESC";
						}
